...
websocket_urlpatterns = [
    path('ws/channel1/', consumer.ConsumerChannel1.as_asgi()),  # Matches exactly /ws/channel1/
    path('ws/channel2/', consumer.ConsumerChannel2.as_asgi()),  # Matches exactly /ws/channel2/
]